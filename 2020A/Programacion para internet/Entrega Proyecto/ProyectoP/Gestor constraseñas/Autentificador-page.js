...
var AutentificadorViewModel = require("./Autentificador-view-model");
var autentificadorViewModel = new AutentificadorViewModel();
...
function pageLoaded(args) {
	...
	page.bindingContext = autentificadorViewModel;
}
