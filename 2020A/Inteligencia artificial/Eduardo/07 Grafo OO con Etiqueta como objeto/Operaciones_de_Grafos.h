...
public:
    ...
    EtiquetaVertice etiquetaVertice(Vertice<EtiquetaVertice>& v);//porque no se puede manejar con const?
};
...
template <class EtiquetaVertice,class EtiquetaArco>
void Grafo<EtiquetaVertice,EtiquetaArco>::insertaArco(EtiquetaArco x,Vertice<EtiquetaVertice>* v, Vertice<EtiquetaVertice>* w){
    arcos[(v->numVertice-1)*numVertices+w->numVertice-1]=new Arco<EtiquetaArco>(x);
}

template <class EtiquetaVertice,class EtiquetaArco>
EtiquetaArco Grafo<EtiquetaVertice,EtiquetaArco>::suprimeArco(const Vertice<EtiquetaVertice>& v, const Vertice<EtiquetaVertice>& w){
...
template <class EtiquetaVertice,class EtiquetaArco>
EtiquetaArco Grafo<EtiquetaVertice,EtiquetaArco>::etiquetaArco(Vertice<EtiquetaVertice>* v,Vertice<EtiquetaVertice>* w){
    Arco<EtiquetaArco>* arco=arcos[(v->numVertice-1)*numVertices+w->numVertice-1];
