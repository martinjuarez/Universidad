    ...
    public void Avanzar(String[][] matriz, int filas, int colum) {
        ...
        while (golpes < 5) {
            if (matriz[filas][colum] == matriz[arreglo[0]][arreglo[1]]) {
                ...
                System.out.println("J = Derecha");
                System.out.println("G = Izquierda");
                System.out.println("Y = Arriba");
                System.out.println("H = Abajo");
        ...
        while (matriz[filas][colum] != matriz[arreglo[0]][arreglo[1]]) {    
            ...
            switch (direccion) {
                case "derecha"://DERECHA
                    if (!matriz[filas - 1][colum].equals("0") && !matriz[filas - 1][colum].equals("|") && !matriz[filas-1][colum].equals("-")) {
                        matriz[filas - 1][colum] = "*";
                        matriz[filas][colum] = " ";
                        filas--;
                        direccion = "arriba";
                    } else {
                        if (!matriz[filas][colum + 1].equals("0") && !matriz[filas][colum + 1].equals("|") && !matriz[filas][colum + 1].equals("-")) {
                            matriz[filas][colum + 1] = "*";
                            matriz[filas][colum] = " ";
                            colum++;
                        } else {
